export const products = [
  ...
  },
  {
    ...
    name: "TASCO Solutions",
    shortDescription: "Advanced integrated solutions for water management, energy efficiency, and AI-driven compliance.",
    description: "TASCO Solutions offers a comprehensive suite of advanced technologies designed to optimize industrial operations. From smart water management and energy efficiency to AI-powered compliance monitoring, our integrated platform helps industries achieve operational excellence, sustainability, and regulatory adherence.",
    ...
    benefits: [
      { title: "Optimized", description: "Maximize resource efficiency" },
      { title: "Compliant", description: "Automated regulatory adherence" },
      { title: "Sustainable", description: "Reduce environmental impact" },
    ],
    additionalProducts: [
      {
        id: "dnp-water",
        ...
        name: "DNP Water",
        shortDescription: "Digital networking platform for efficient water distribution and management.",
        description: "DNP Water provides a digital networking platform designed to revolutionize water management. By leveraging advanced sensors and data analytics, it ensures efficient water distribution, leak detection, and quality monitoring, helping municipalities and industries optimize water usage and reduce wastage.",
        ...
        benefits: [
          { title: "Save Water", description: "Minimize wastage effectively" },
          { title: "Smart Grid", description: "Intelligent distribution network" },
          { title: "Eco-Friendly", description: "Sustainable water practices" },
        ],
      },
      {
        id: "dnp-energy",
        ...
        name: "DNP Energy",
        shortDescription: "Advanced solutions for industrial energy monitoring and optimization.",
        description: "DNP Energy delivers cutting-edge solutions for monitoring and optimizing energy consumption in industrial settings. Our platform provides real-time insights into energy usage patterns, identifies inefficiencies, and suggests optimization strategies to reduce costs and carbon footprint.",
        ...
        benefits: [
          { title: "Reduce Cost", description: "Lower energy bills" },
          { title: "Green Tech", description: "Lower carbon footprint" },
          { title: "Efficiency", description: "Optimize energy usage" },
        ],
      },
      {
        id: "tasco-ai-compliance",
        slug: "tasco-ai-compliance",
        tagline: "AI COMPLIANCE MONITORING",
        name: "TASCO AI Compliance",
        shortDescription: "AI-driven system for ensuring industrial regulatory compliance and safety.",
        description: "TASCO AI Compliance leverages artificial intelligence to automate regulatory compliance monitoring. By analyzing operational data against legal and safety standards, it ensures that your facility adheres to all necessary regulations, reducing the risk of penalties and enhancing workplace safety.",
        iconName: "ShieldCheck" as const,
        color: "#10b981", // Emerald-500
        ...
        benefits: [
          { title: "100% Compliant", description: "Always audit-ready" },
          { title: "Automated", description: "Reduce manual oversight" },
          { title: "Risk Free", description: "Mitigate legal risks" },
        ],
      },
    ],
  },
