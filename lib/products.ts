export const products = [
  ...
  },
  {
    ...
    name: "Fingerprint Liveness Detection",
    shortDescription: "Advanced anti-spoofing technology to detect fake fingerprints and ensure secure biometric authentication.",
    description: "Secure your biometric systems with our Fingerprint Liveness Detection technology. Designed to prevent spoofing attacks using fake fingerprints (silicone, latex, or gelatin), our AI-powered solution analyzes texture, depth, and physiological signs of life to verify the authenticity of the user in real-time.",
    iconName: "Fingerprint" as const,
    color: "#6366f1", // Indigo-500
    gradient: "from-indigo-500 to-violet-600",
    hasVideo: false,
    demoUrl: "/finger_print_pitch_deck_yellowsense.pdf",
    features: [
      "Real-time spoof detection",
      "Material analysis (silicone, latex, etc.)",
      "Integration with existing sensors",
      "High-accuracy liveness scoring",
